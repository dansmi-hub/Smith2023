...
\author*[1,2]{\fnm{Daniel} \sur{Smith}}\email{dansmi@ceh.ac.uk}
\equalcont{These authors contributed equally to this work.}

\author[1]{\fnm{Stefanie} \sur{Schäfer}}\email{smsc@ceh.ac.uk}
\equalcont{These authors contributed equally to this work.}
...
\author[3]{\fnm{Nick} \sur{Golding}}\email{nick.golding.research@gmail.com}

\author[3]{\fnm{Miles} \sur{Nunn}}\email{miles.nunn@akaritx.com}

%% \author[3]{\fnm{Rachael} \sur{Madison}}\email{Unknown}

\author[1]{\fnm{Steven} \sur{White}}\email{smwhit@ceh.ac.uk}

\author[2]{\fnm{Amanda} \sur{Callaghan}}\email{a.callaghan@reading.ac.uk}

\author[1]{\fnm{Bethan} \sur{Purse}}\email{beth@ceh.ac.uk}
